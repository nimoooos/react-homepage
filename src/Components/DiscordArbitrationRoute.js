...
export default function DiscordArbitrationRoute() {
    return (
        <>
            ...
            <p>Note: I'm not a lawyer, and I urge you to seek more information on what to do. It's possible that this email isn't enough. Please let me know <a href="https://github.com/nimoooos/react-homepage/issues" target="_blank">here</a>.</p>
